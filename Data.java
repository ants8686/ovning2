...
public final class Data {
	...
	private void addWithGenres(int year, String title, String artist, String mainGenre, String subGenre) {
		var genres = Arrays.stream(mainGenre.split(",")).map(String::trim).collect(Collectors.toUnmodifiableSet());
	...
	private void loadData() {
		...
		addWithGenres(1987, "Appetite for Destruction", "Guns N' Roses", "Rock", "Hard Rock, Heavy Metal");
		...
		addWithGenres(1973, "(pronounced 'leh-'nerd 'skin-'nerd)", "Lynyrd Skynyrd", "Rock", "Blues Rock, Hard Rock, Southern Rock");
