...
public class Exercise2 {
    ...
    private static final Recording EXISTING_RECORDING = new Recording(EXISTING_TITLE, EXISTING_ARTIST, 1965, "CD", Set.of(EXISTING_GENRE));
    private static final Recording MISSING_RECORDING = new Recording(MISSING_TITLE, MISSING_ARTIST, 2021, "LP", Set.of(MISSING_GENRE));
...
//			if (optionalGetRecordingsByArtistOrderedByTitleAsc.size() != NUMBER_OF_RECORDINGS_BY_COLTRANE) {
//				throw new AssertionError("optionalGetRecordingsByArtistOrderedByTitleAsc: wrong number of recordings.");
//			}
//		}
